...
const Favourites = () => {
  ...
  // find a way to fix the issue of the images not loading sometimes, maybe run API search function for that one recipe and update the image link in the state??
                ...
                {favouriteRecipes.recipe.image ? (
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      e.target.title = 'click to try search again...';
                    }}
                  />
